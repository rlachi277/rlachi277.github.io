import { buildLog1Row, buildLog1Table, LOG1_TYPE_NAME } from "../../shared/cycelog/log1.js";
import { getPostFromData, postExists } from "../posts/posts.js";
...
export function getLog1(db, root, postId, template, renderHooks) {
	...
	return rendered.replace(LOG1_TEMPLATE_SLOT, buildLog1Table(getLog1Entries(db, postId)));
}

function log1Header(id) {
	return {
		type: "body",
		children: [
