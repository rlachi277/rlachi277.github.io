...
const log3Template = loadTemplate('log3.html');
const log3NotFoundTemplate = loadTemplate('log3_404.html');
...
const log1Template = loadTemplate('log1.html');
const log1NotFoundTemplate = loadTemplate('log1_404.html');
...
function loadTemplate(filename) {
	return fs.readFileSync(
		path.join(__dirname, 'client', 'cycelog', filename),
		'utf8'
	).replaceAll(/\n|\t/g, '');
}
